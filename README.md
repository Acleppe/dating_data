...
We don't need an NIH-funded Harvard study to tell us this, of course.  But it _is_ neat to see it borne out in my own dating history.  By and large, I have to be on the same page intellectually or comedically if I want to be reliable friends with someone.  If I am attracted to them and have a romantic chemistry, then I appear to be willing to "trade in" a bit of mental rapport and mirth for the even more sought-after and more elusive true intimate connection.  I suspect my experience with this echoes that of most men my age and younger, for better or worse.  
